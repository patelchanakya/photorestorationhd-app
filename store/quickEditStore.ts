...
export interface QuickEditState {
  visible: boolean;
  stage: QuickStage;
  functionType: 'restoration' | 'repair' | 'restore_repair' | 'unblur' | 'colorize' | 'descratch' | 'enlighten' | 'background' | 'outfit' | 'custom' | 'memorial' | 'water_damage' | 'nano_outfit' | 'nano_background' | null;
