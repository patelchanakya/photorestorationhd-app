-- Migration: Fix date type handling in atomic functions
-- The last_video_date column is DATE type, not TEXT

-- Function to atomically check and increment usage (FINAL FIXED VERSION)
...
-- Function to rollback usage increment (FINAL FIXED VERSION)
