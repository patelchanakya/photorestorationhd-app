-- Migration: Revert to correct DATE type handling (not TEXT)
-- The last_video_date column is actually DATE type, not TEXT

-- Function to atomically check and increment usage (CORRECT DATE TYPES)
