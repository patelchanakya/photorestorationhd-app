...
serve(async (req) => {
  ...
  try {
    ...
    console.log('✨ Starting custom generation with prompt:', custom_prompt.substring(0, 100))
    ...
    console.log('🔄 Calling Replicate API for custom generation...')
    ...
    console.log('✅ Custom generation completed successfully')
